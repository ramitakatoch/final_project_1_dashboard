...
export default function ReviewForm(props) {
    ...
    const intialValues = { firstName: "", lastName: "", email: "", massage: "" };
    ...
    const validate = (values) => {
        ...
        const messageRegex = /^(?=.{1,50}$)[a-z]+(?:['_.\s][a-z]+)*$/i
        ...
        } else if (!((values.message).length >= 30 && (values.password).Message <= 40)) {
            errors.message = "Must be of 30 - 40 characters";
        }
        ...
        <>
            ...
            <Form onSubmit={handleSubmit} noValidate>
                ...
                <Form.Group className="mb-3" controlId="loginForm.ControlInput4">
                    ...
                    <Form.Control as="textarea" rows={3} placeholder="Message" value={formValues.message} onChange={handleChange} className={formErrors.message && "input-error"} />
